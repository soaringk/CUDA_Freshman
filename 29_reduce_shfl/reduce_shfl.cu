...
{
    localSum += __shfl_xor_sync(0xffffffff, localSum, 16, 32);
    localSum += __shfl_xor_sync(0xffffffff, localSum, 8, 32);
    localSum += __shfl_xor_sync(0xffffffff, localSum, 4, 32);
    localSum += __shfl_xor_sync(0xffffffff, localSum, 2, 32);
    localSum += __shfl_xor_sync(0xffffffff, localSum, 1, 32);
